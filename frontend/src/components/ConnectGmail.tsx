...
export function ConnectGmail({ onConnect, onSuccess }: ConnectGmailProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
        <div className="max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Gmail Connected!</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Unlock AI-powered email intelligence. We'll analyze your emails and show you what matters.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
            ...
            <p className="text-center text-sm text-gray-500 dark:text-gray-400">
              We request <strong>read-only access</strong> to your Gmail. Your data is encrypted and never shared.
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 text-center">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              ...
              <p className="text-xs font-medium text-gray-900 dark:text-white">Private</p>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              ...
              <p className="text-xs font-medium text-gray-900 dark:text-white">Smart</p>
